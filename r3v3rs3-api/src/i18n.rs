...
mod tests {
    ...
    fn all_errors() -> Vec<Error> {
        ...
        vec![
            ...
            Error::NotificationWebhookUrlInvalid { url: text() },
            Error::NotificationWebhookMissing,
            Error::NotificationFailed { reason: text() },
            ...
            Error::PasswordTooShort { min: 8 },
            Error::AccountExists { username: text() },
            Error::AccountNotFound { username: text() },
            Error::CannotChangeOwnAccount,
            Error::InvalidAccountScope,
            Error::LastAdmin,
