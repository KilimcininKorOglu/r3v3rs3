...
- Discovers proxies from Docker container labels, Consul service tags and the Consul and etcd key-value stores, and updates them when the source changes ([Service Discovery](@/discovery.md))
