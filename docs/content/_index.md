...
- Discovers proxies from Docker container labels, Consul service tags and the Consul key-value store, and updates them when the source changes ([Service Discovery](@/discovery.md))
