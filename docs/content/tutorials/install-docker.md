...
The volumes keep the configuration and the accounts, so no account is created again. Pin a version with the tag, for example `:v1.5.5`, when you upgrade several hosts in steps.
